...
<script src="<?php echo base_url()?>asset/dist/js/sweetalert2.all.min.js"></script>

<script src="<?php echo base_url()?>asset/dist/js/myscript.js"></script>
<!-- Sparkline -->
<script src="<?php echo base_url()?>asset/bower_components/jquery-sparkline/<?php echo base_url()?>asset/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap  -->
